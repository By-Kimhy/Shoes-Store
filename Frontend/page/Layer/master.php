						...
						<div class="single-deal">
							...
							<a href="assets/img/category/c1.jpg" class="img-pop-up" target="_blank">
								<div class="deal-details">
									<h6 class="deal-title">ស្បែកជើងសម្រាប់កីឡា</h6>
								</div>
							</a>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-4">
						<div class="single-deal">
							...
							<a href="assets/img/category/c3.jpg" class="img-pop-up" target="_blank">
								<div class="deal-details">
									<h6 class="deal-title">ផលិតផលសម្រាប់គូស្នេហ៍</h6>
								</div>
							</a>
						</div>
					</div>
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-product">
								<img class="img-fluid"
									src="../backend/assets/img/product_img/<?php echo $row['Product_photo'] ?>" alt="">
								<div class="product-details">
									<h6><?php echo $row['Product_Name'] ?>
	...
	<div class="single-product-slider">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-6 text-center">
					<div class="section-title">
						<h1>ផលិតផល មកដល់ឆាប់ៗនេះ</h1>
						<p>Nike មិនចង់បង្កើតផលិតផលសម្រាប់មនុស្សគ្រប់គ្នាទេ
							ពួកយើងចង់ផលិតផលិតផលសម្រាប់ជើងឯក</p>
					</div>
				</div>
			</div>
			<div class="row">
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-6 no-padding exclusive-left">
				<div class="row clock_sec clockdiv" id="clockdiv">
					<div class="col-lg-12">
						<h1>ប្រូម៉ូសិនពិសេសបំផុត បញ្ចប់ក្នុងពេលឆាប់ៗនេះ!</h1>
						<p>អ្នកដែលស្រលាញ់ខ្លាំងជាមួយប្រព័ន្ធអេកូឡូស៊ី</p>
					</div>
					<div class="col-lg-12">
				...
				<a href="#" class="primary-btn">ទិញឥឡូវនេះ</a>
			</div>
