		...
		<div id="aba_main_modal" class="aba-modal">
			<!— Modal content —>
				<div class="aba-modal-content">
					...
					$req_time = time();
					$merchant_id = "ec438376";
					$transactionId = time();
					$amount = '10.00';
					$firstName = 'Kimhy';
					$lastName = 'By';
					$phone = '093630466';
					$email = 'By.kimhy@ababank.com';
					$return_params = "Hello!";
					$type = "Purchase";
					...
					<form method="POST" target="aba_webservice" action="<?php echo PayWayApiCheckout::getApiUrl(); ?>"
						...
						<?php echo PayWayApiCheckout::getHash($req_time . $merchant_id . $transactionId . $amount . $items . $shipping . $firstName . $lastName . $email . $phone . $type //. $payment_option
							. $currency . $return_params); ?>" id="hash" />
